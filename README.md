...
2. Классифицировать запрос: HR, юридический, шаблон документа, неизвестно.
3. Найти релевантные чанки через hybrid retrieval: `pgvector` + BM25.
4. Объединить и переоценить результаты по similarity score, BM25 score и количеству релевантных источников.
5. Если confidence ниже порога, отказать и попросить уточнить вопрос.
6. Если confidence достаточный, сформировать ответ с кратким выводом и источниками.
7. Записать вопрос, ответ, источники и оценку в лог.
