...
HELP_TEXT = (
    ...
    "• Помогаю подготовить безопасный черновик приказа о приёме или отпуске: сначала определяю тип документа и недостающие поля.\n"
    ...
    "<b>Черновики</b>\n"
    "Напишите: «Подготовь приказ об отпуске» или «Подготовь приказ о приёме». "
    "Я не выдам финальный документ без полей и проверки HR/Legal.\n\n"
    "<b>Команды</b>\n"
    "/help — эта справка\n"
