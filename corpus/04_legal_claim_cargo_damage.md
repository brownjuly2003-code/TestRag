...
title: Претензия авиаперевозчику о повреждении груза
...
# Претензия авиаперевозчику о повреждении груза

## Назначение

Претензия авиаперевозчику о повреждении груза используется для сценария: груз выдан с повреждением упаковки или
содержимого после terminal handling. Это претензия контрагенту для конкретного air cargo dispute, а не общая форма без shipment evidence.

Позиция строится на доказательствах: AWB/MAWB/HAWB, cargo manifest, damage report терминала/GHA, фото до и после
выдачи, весовая сверка, claim notice. AWB/MAWB/HAWB, airport pair, flight number, terminal/GHA records, customs
и dangerous goods учитываются только как проверяемые факты, ограничения или причины эскалации.

## Область применения

Документ применяется, когда карточка спора подтверждает профиль «повреждение авиагруза», сторону спора, сумму
...
признания вины или долга. Для события «carrier/GHA damage investigation или уведомление страховщика» Legal
согласует escalation route с operations, finance, insurer, broker или external counsel.

## Термины

- **Повреждение авиагруза** — профиль претензии или письма, который определяет предмет доказывания и безопасную
  позицию.
- **Evidence bundle** — AWB/MAWB/HAWB, cargo manifest, damage report терминала/GHA, фото до и после выдачи,
  весовая сверка, claim notice; комплект используется для chronology, liability, amount, mitigation и вручения.
- **Без признания** — ответ не подтверждает долг, вину, causation, размер ущерба, waiver of rights или отказ от
  liability cap.
- **Escalation trigger** — carrier/GHA damage investigation или уведомление страховщика; событие требует решения
...
- Владелец спора сверяет профиль «повреждение авиагруза», карточку спора, срок ответа, способ вручения и
  evidence: AWB/MAWB/HAWB, cargo manifest, damage report терминала/GHA, фото до и после выдачи, весовая сверка,
  claim notice.
...
- Эскалация обязательна при событии: carrier/GHA damage investigation или уведомление страховщика. До решения
...
- Сценарий: после прибытия рейса cargo terminal выдал груз с wet/crush damage и damage report GHA.
...
- Подтвердить источниками: AWB/MAWB/HAWB, booking, flight number, cargo manifest, акт терминала или GHA, фото повреждения или расхождения, отметки screening/handling/customs, temperature log при special cargo, invoices/rate sheet, переписка с авиаперевозчиком, GHA, экспедитором, customs broker и страховщиком. Дополнительно: cargo damage report, фото до/после handling, акт выдачи, insurance notice.
...
- Использовать документ как источник типа «претензия контрагенту» по теме «Претензия авиаперевозчику о повреждении груза» только при фактическом совпадении запроса с air cargo dispute.
...
- Основные источники: AWB/MAWB/HAWB, cargo manifest, damage report терминала/GHA, фото до и после выдачи,
  весовая сверка, claim notice.
...
- Проверяемое ограничение: нельзя утверждать причину повреждения без custody timeline, фото и отметок
  acceptance/release.
...
| Какие факты нужны для «Претензия авиаперевозчику о повреждении груза»? | Перечислить недостающие AWB, booking, рейс, airport pair, timeline события, сумму, доказательства вручения и ответственных. |

## Ответственные роли

| Роль | Зона ответственности |
|------|----------------------|
| Руководитель юридического отдела | утверждает позицию по профилю «повреждение авиагруза», settlement authority, waiver и спорные liability caps |
| Cargo claims lead | ведет chronology, evidence bundle, срок ответа и коммуникацию по событию: carrier/GHA damage investigation или уведомление страховщика |
| Air cargo operations / GHA contact | подтверждает для «Претензия авиаперевозчику о повреждении груза» movement, acceptance/offload/release, terminal act, handling records и operational root cause |
| Finance / insurer / broker contact | сверяет по «Претензия авиаперевозчику о повреждении груза» сумму требования, reserve, оплату, customs costs, insurance notice и право регресса |

## Риски и ограничения

- Нельзя направлять документ без evidence по профилю «повреждение авиагруза»: AWB/MAWB/HAWB, cargo manifest,
  damage report терминала/GHA, фото до и после выдачи, весовая сверка, claim notice.
- Ключевое ограничение: нельзя утверждать причину повреждения без custody timeline, фото и отметок
  acceptance/release.
...
- ответ относится к профилю «повреждение авиагруза» и не подменяет его общей претензионной процедурой
- доказательства названы предметно: AWB/MAWB/HAWB, cargo manifest, damage report терминала/GHA, фото до и после
  выдачи, весовая сверка, claim notice
- отдельно указано ограничение или gap: нельзя утверждать причину повреждения без custody timeline, фото и
  отметок acceptance/release
- срок ответа, способ вручения, escalation route и safe legal position отражены явно

## Контрольный список

- [ ] карточка спора сопоставлена с документом «Претензия авиаперевозчику о повреждении груза» и профилем
  «повреждение авиагруза»
- [ ] собран evidence bundle: AWB/MAWB/HAWB, cargo manifest, damage report терминала/GHA, фото до и после
  выдачи, весовая сверка, claim notice
- [ ] проверены claim notice, limitation period, proof of delivery/service и authority signer
- [ ] оценено ограничение: нельзя утверждать причину повреждения без custody timeline, фото и отметок
  acceptance/release
...
Внеплановый пересмотр нужен после события: carrier/GHA damage investigation или уведомление страховщика; также
...
При пересмотре Legal проверяет закрытые дела профиля «повреждение авиагруза»: какие evidence сработали, какие
...
> Применять «Претензия авиаперевозчику о повреждении груза» после подтверждения владельцем процесса; спорные и нетиповые кейсы требуют ручной проверки.
