...
- **Рабочий экземпляр «Договор авиаперевозки»** — версия документа с датой, владельцем процесса, статусом согласования и приложениями, по которой можно принимать внутреннее решение.
- **Основание применения «Договор авиаперевозки»** — заявка, приказ, договор, акт, обращение или иной первичный документ, без которого ассистент не должен формировать окончательный вывод.
...
- Аэропорт отправления: {{airport_origin}}
...
- Владелец процесса проверяет, что «Договор авиаперевозки» применяется к подтвержденной air cargo операции,
  а не к общей перевозке без booking, AWB/MAWB/HAWB и terminal record.
- Рабочий комплект: операционный комплект для «Договор авиаперевозки»: booking, AWB/MAWB/HAWB, terminal
  record и доказательства отклонений. CMR/ТТН, GPS и данные водителя используются только для наземного
  подвоза или вывоза, если этот участок связан с airport pair и рейсом.
...
- Для «Договор авиаперевозки» air cargo профиль строится вокруг подтвержденного airport pair, flight number,
  booking, AWB/MAWB/HAWB, cutoff time, terminal handling, security screening, ULD/pallet build-up и
  chargeable weight.
- Предметная опора документа: операционный комплект для «Договор авиаперевозки»: booking, AWB/MAWB/HAWB,
  terminal record и доказательства отклонений. Эти факты должны быть видны в TMS/WMS/terminal log, акте,
  фото, переписке carrier/GSA или связанном документе.
...
- Special cargo требует ручной проверки для dangerous goods, lithium batteries, pharma/cold chain,
  perishables, oversized и valuable cargo; HOLD наступает, если нет booking/AWB, terminal record, evidence
  pack или владельца отклонения.
- Эскалация идет через logistics, terminal, carrier/GSA, finance, compliance и legal, чтобы документ не
...
- Если фактов по «Договор авиаперевозки» не хватает, вернуть уточняющие вопросы; даты, суммы, доступы и реквизиты оставлять неподтвержденными до проверки.
...
| Можно ли применять автоматически? | Только после проверки ограничений по «Договор авиаперевозки»; при риске или неполных фактах нужна ручная проверка. |
...
| Логист/диспетчер | проверяет airport pair, flight, booking, AWB, cargo, terminal, carrier/GSA и наземное плечо при наличии |
| Терминал / склад | передает terminal acceptance, screening/build-up records, акты и timestamps |
| Владелец наземного плеча | передает CMR/ТТН, GPS, пломбы и данные водителя только для first/last mile |
| Юрист/Compliance | оценивает ответственность, санкционные ограничения, ПДн и допустимость раскрытия carrier evidence |
...
- [ ] недостающие факты по «Договор авиаперевозки» вынесены в уточняющие вопросы
...
> Применять «Договор авиаперевозки» после подтверждения владельцем процесса; спорные и нетиповые кейсы требуют ручной проверки.
