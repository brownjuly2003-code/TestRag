...
title: Письмо о взыскании задолженности за авиагрузовые услуги
...
# Письмо о взыскании задолженности за авиагрузовые услуги

## Назначение

Письмо о взыскании задолженности за авиагрузовые услуги используется для сценария: контрагенту направляется
досудебное письмо по просроченным air cargo charges. Это письмо для конкретного air cargo dispute, а не общая форма без shipment evidence.

Позиция строится на доказательствах: debt ledger, invoices, AWB list, acts, reconciliation, proof of services,
delivery receipt for demand. AWB/MAWB/HAWB, airport pair, flight number, terminal/GHA records, customs и
dangerous goods учитываются только как проверяемые факты, ограничения или причины эскалации.

## Область применения

Документ применяется, когда карточка спора подтверждает профиль «письмо о взыскании задолженности», сторону
...
признания вины или долга. Для события «credit block, payment plan или security call» Legal согласует escalation
route с operations, finance, insurer, broker или external counsel.

## Термины

- **Письмо о взыскании задолженности** — профиль претензии или письма, который определяет предмет доказывания и
  безопасную позицию.
- **Evidence bundle** — debt ledger, invoices, AWB list, acts, reconciliation, proof of services, delivery
  receipt for demand; комплект используется для chronology, liability, amount, mitigation и вручения.
- **Без признания** — ответ не подтверждает долг, вину, causation, размер ущерба, waiver of rights или отказ от
  liability cap.
- **Escalation trigger** — credit block, payment plan или security call; событие требует решения по сроку
  ответа, settlement authority и уведомлению страховщика или руководителя.
...
- Владелец спора сверяет профиль «письмо о взыскании задолженности», карточку спора, срок ответа, способ
  вручения и evidence: debt ledger, invoices, AWB list, acts, reconciliation, proof of services, delivery
  receipt for demand.
...
- Эскалация обязательна при событии: credit block, payment plan или security call. До решения текст не должен
  признавать долг, вину, causation, сумму ущерба или отказ от прав.
...
- Сценарий: контрагент просрочил оплату freight и terminal handling по реестру AWB.
...
- Подтвердить источниками: AWB/MAWB/HAWB, booking, flight number, cargo manifest, акт терминала или GHA, фото повреждения или расхождения, отметки screening/handling/customs, temperature log при special cargo, invoices/rate sheet, переписка с авиаперевозчиком, GHA, экспедитором, customs broker и страховщиком. Дополнительно: invoice register, AWB list, reconciliation act, payment ledger, rate sheet.
...
- Использовать документ как источник типа «письмо» по теме «Письмо о взыскании задолженности за авиагрузовые услуги» только при фактическом совпадении запроса с air cargo dispute.
...
- Основные источники: debt ledger, invoices, AWB list, acts, reconciliation, proof of services, delivery receipt
  for demand.
...
- Проверяемое ограничение: нельзя угрожать мерами без суммы undisputed debt, срока оплаты и contract notice
  route.
...
| Какие факты нужны для «Письмо о взыскании задолженности за авиагрузовые услуги»? | Перечислить недостающие AWB, booking, рейс, airport pair, timeline события, сумму, доказательства вручения и ответственных. |

## Ответственные роли

| Роль | Зона ответственности |
|------|----------------------|
| Руководитель юридического отдела | утверждает позицию по профилю «письмо о взыскании задолженности», settlement authority, waiver и спорные liability caps |
| Debt collection owner | ведет chronology, evidence bundle, срок ответа и коммуникацию по событию: credit block, payment plan или security call |
| Air cargo operations / GHA contact | подтверждает для «Письмо о взыскании задолженности за авиагрузовые услуги» movement, acceptance/offload/release, terminal act, handling records и operational root cause |
| Finance / insurer / broker contact | сверяет по «Письмо о взыскании задолженности за авиагрузовые услуги» сумму требования, reserve, оплату, customs costs, insurance notice и право регресса |

## Риски и ограничения

- Нельзя направлять документ без evidence по профилю «письмо о взыскании задолженности»: debt ledger, invoices,
  AWB list, acts, reconciliation, proof of services, delivery receipt for demand.
- Ключевое ограничение: нельзя угрожать мерами без суммы undisputed debt, срока оплаты и contract notice route.
...
- ответ относится к профилю «письмо о взыскании задолженности» и не подменяет его общей претензионной процедурой
- доказательства названы предметно: debt ledger, invoices, AWB list, acts, reconciliation, proof of services,
  delivery receipt for demand
- отдельно указано ограничение или gap: нельзя угрожать мерами без суммы undisputed debt, срока оплаты и
  contract notice route
- срок ответа, способ вручения, escalation route и safe legal position отражены явно

## Контрольный список

- [ ] карточка спора сопоставлена с документом «Письмо о взыскании задолженности за авиагрузовые услуги» и
  профилем «письмо о взыскании задолженности»
- [ ] собран evidence bundle: debt ledger, invoices, AWB list, acts, reconciliation, proof of services, delivery
  receipt for demand
- [ ] проверены claim notice, limitation period, proof of delivery/service и authority signer
- [ ] оценено ограничение: нельзя угрожать мерами без суммы undisputed debt, срока оплаты и contract notice
  route
...
Внеплановый пересмотр нужен после события: credit block, payment plan или security call; также после нового
claim pattern, изменения carrier/GHA rules, customs practice, insurance wording, limitation period или судебной
практики.

При пересмотре Legal проверяет закрытые дела профиля «письмо о взыскании задолженности»: какие evidence
...
> Применять «Письмо о взыскании задолженности за авиагрузовые услуги» после подтверждения владельцем процесса; спорные и нетиповые кейсы требуют ручной проверки.
