...
title: Доверенность на подписание air cargo документов и претензий
...
# Доверенность на подписание air cargo документов и претензий

## Назначение

Доверенность на подписание air cargo документов и претензий используется для сценария: представитель подписывает
claims, settlement, release, contract notices или shipment documents. Это доверенность для конкретного air cargo
dispute, а не общая форма без shipment evidence.

Позиция строится на доказательствах: authority matrix, contract list, AWB/booking scope, sample documents,
counterparty notice route, validity period. AWB/MAWB/HAWB, airport pair, flight number, terminal/GHA records,
customs и dangerous goods учитываются только как проверяемые факты, ограничения или причины эскалации.

## Область применения

Документ применяется, когда карточка спора подтверждает профиль «подписание air cargo документов», сторону
...
признания вины или долга. Для события «urgent document signing, route change или claim response deadline» Legal
согласует escalation route с operations, finance, insurer, broker или external counsel.

## Термины

- **Подписание air cargo документов** — профиль претензии или письма, который определяет предмет доказывания и
  безопасную позицию.
- **Evidence bundle** — authority matrix, contract list, AWB/booking scope, sample documents, counterparty
  notice route, validity period; комплект используется для chronology, liability, amount, mitigation и вручения.
- **Без признания** — ответ не подтверждает долг, вину, causation, размер ущерба, waiver of rights или отказ от
  liability cap.
- **Escalation trigger** — urgent document signing, route change или claim response deadline; событие требует
...
Предмет полномочий: Доверенность на подписание air cargo документов и претензий
...
- Владелец спора сверяет профиль «подписание air cargo документов», карточку спора, срок ответа, способ вручения
  и evidence: authority matrix, contract list, AWB/booking scope, sample documents, counterparty notice route,
  validity period.
...
- Эскалация обязательна при событии: urgent document signing, route change или claim response deadline. До
...
- Сценарий: операционному руководителю нужны полномочия подписать claim по неверному AWB.
...
- Подтвердить источниками: AWB/MAWB/HAWB, booking, flight number, cargo manifest, акт терминала или GHA, фото повреждения или расхождения, отметки screening/handling/customs, temperature log при special cargo, invoices/rate sheet, переписка с авиаперевозчиком, GHA, экспедитором, customs broker и страховщиком. Дополнительно: authority matrix, AWB list, counterparty list, monetary limit, excluded powers.
...
- Использовать документ как источник типа «доверенность» по теме «Доверенность на подписание air cargo документов и претензий» только при фактическом совпадении запроса с air cargo dispute.
...
- Основные источники: authority matrix, contract list, AWB/booking scope, sample documents, counterparty notice
...
- Проверяемое ограничение: нельзя включать полномочия на waiver/settlement без отдельного лимита и approval.
...
| Какие факты нужны для «Доверенность на подписание air cargo документов и претензий»? | Перечислить недостающие AWB, booking, рейс, airport pair, timeline события, сумму, доказательства вручения и ответственных. |

## Ответственные роли

| Роль | Зона ответственности |
|------|----------------------|
| Руководитель юридического отдела | утверждает позицию по профилю «подписание air cargo документов», settlement authority, waiver и спорные liability caps |
| Contract authority owner | ведет chronology, evidence bundle, срок ответа и коммуникацию по событию: urgent document signing, route change или claim response deadline |
| Air cargo operations / GHA contact | подтверждает для «Доверенность на подписание air cargo документов и претензий» movement, acceptance/offload/release, terminal act, handling records и operational root cause |
| Finance / insurer / broker contact | сверяет по «Доверенность на подписание air cargo документов и претензий» сумму требования, reserve, оплату, customs costs, insurance notice и право регресса |

## Риски и ограничения

- Нельзя направлять документ без evidence по профилю «подписание air cargo документов»: authority matrix,
  contract list, AWB/booking scope, sample documents, counterparty notice route, validity period.
- Ключевое ограничение: нельзя включать полномочия на waiver/settlement без отдельного лимита и approval.
...
- ответ относится к профилю «подписание air cargo документов» и не подменяет его общей претензионной процедурой
- доказательства названы предметно: authority matrix, contract list, AWB/booking scope, sample documents,
  counterparty notice route, validity period
- отдельно указано ограничение или gap: нельзя включать полномочия на waiver/settlement без отдельного лимита и
  approval
- срок ответа, способ вручения, escalation route и safe legal position отражены явно

## Контрольный список

- [ ] карточка спора сопоставлена с документом «Доверенность на подписание air cargo документов и претензий» и
  профилем «подписание air cargo документов»
- [ ] собран evidence bundle: authority matrix, contract list, AWB/booking scope, sample documents, counterparty
  notice route, validity period
- [ ] проверены claim notice, limitation period, proof of delivery/service и authority signer
- [ ] оценено ограничение: нельзя включать полномочия на waiver/settlement без отдельного лимита и approval
...
Внеплановый пересмотр нужен после события: urgent document signing, route change или claim response deadline;
...
При пересмотре Legal проверяет закрытые дела профиля «подписание air cargo документов»: какие evidence
...
> Применять «Доверенность на подписание air cargo документов и претензий» после подтверждения владельцем процесса; спорные и нетиповые кейсы требуют ручной проверки.
