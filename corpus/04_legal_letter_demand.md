...
title: Исковое заявление по авиагрузовому спору
...
# Исковое заявление по авиагрузовому спору

## Назначение

Исковое заявление по авиагрузовому спору используется для сценария: готовится формальная demand position перед
подачей иска или претензии. Это исковое заявление для конкретного air cargo dispute, а не общая форма без shipment evidence.

Позиция строится на доказательствах: claim chronology, contract, AWB/HAWB, evidence bundle, calculation, state
duty estimate, proof of service. AWB/MAWB/HAWB, airport pair, flight number, terminal/GHA records, customs и
dangerous goods учитываются только как проверяемые факты, ограничения или причины эскалации.

## Область применения

Документ применяется, когда карточка спора подтверждает профиль «исковое требование по air cargo спору», сторону
...
признания вины или долга. Для события «pre-filing review, limitation period или settlement window» Legal
согласует escalation route с operations, finance, insurer, broker или external counsel.

## Термины

- **Исковое требование по air cargo спору** — профиль претензии или письма, который определяет предмет
  доказывания и безопасную позицию.
- **Evidence bundle** — claim chronology, contract, AWB/HAWB, evidence bundle, calculation, state duty estimate,
  proof of service; комплект используется для chronology, liability, amount, mitigation и вручения.
- **Без признания** — ответ не подтверждает долг, вину, causation, размер ущерба, waiver of rights или отказ от
  liability cap.
- **Escalation trigger** — pre-filing review, limitation period или settlement window; событие требует решения
...
- Владелец спора сверяет профиль «исковое требование по air cargo спору», карточку спора, срок ответа, способ
  вручения и evidence: claim chronology, contract, AWB/HAWB, evidence bundle, calculation, state duty estimate,
  proof of service.
...
- Эскалация обязательна при событии: pre-filing review, limitation period или settlement window. До решения
...
- Сценарий: после отказа carrier компенсировать damage claim готовится иск с terminal evidence.
...
- Подтвердить источниками: AWB/MAWB/HAWB, booking, flight number, cargo manifest, акт терминала или GHA, фото повреждения или расхождения, отметки screening/handling/customs, temperature log при special cargo, invoices/rate sheet, переписка с авиаперевозчиком, GHA, экспедитором, customs broker и страховщиком. Дополнительно: pretrial claim, proof of delivery, court calendar, claim calculation, evidence bundle.
...
- Использовать документ как источник типа «исковое заявление» по теме «Исковое заявление по авиагрузовому спору» только при фактическом совпадении запроса с air cargo dispute.
...
- Основные источники: claim chronology, contract, AWB/HAWB, evidence bundle, calculation, state duty estimate,
  proof of service.
...
- Проверяемое ограничение: нельзя формулировать исковые требования без подсудности, claim amount и
...
| Какие факты нужны для «Исковое заявление по авиагрузовому спору»? | Перечислить недостающие AWB, booking, рейс, airport pair, timeline события, сумму, доказательства вручения и ответственных. |

## Ответственные роли

| Роль | Зона ответственности |
|------|----------------------|
| Руководитель юридического отдела | утверждает позицию по профилю «исковое требование по air cargo спору», settlement authority, waiver и спорные liability caps |
| Litigation preparation lead | ведет chronology, evidence bundle, срок ответа и коммуникацию по событию: pre-filing review, limitation period или settlement window |
| Air cargo operations / GHA contact | подтверждает для «Исковое заявление по авиагрузовому спору» movement, acceptance/offload/release, terminal act, handling records и operational root cause |
| Finance / insurer / broker contact | сверяет по «Исковое заявление по авиагрузовому спору» сумму требования, reserve, оплату, customs costs, insurance notice и право регресса |

## Риски и ограничения

- Нельзя направлять документ без evidence по профилю «исковое требование по air cargo спору»: claim chronology,
  contract, AWB/HAWB, evidence bundle, calculation, state duty estimate, proof of service.
- Ключевое ограничение: нельзя формулировать исковые требования без подсудности, claim amount и доказательства
  вручения.
...
- ответ относится к профилю «исковое требование по air cargo спору» и не подменяет его общей претензионной
  процедурой
- доказательства названы предметно: claim chronology, contract, AWB/HAWB, evidence bundle, calculation, state
  duty estimate, proof of service
- отдельно указано ограничение или gap: нельзя формулировать исковые требования без подсудности, claim amount и
  доказательства вручения
- срок ответа, способ вручения, escalation route и safe legal position отражены явно

## Контрольный список

- [ ] карточка спора сопоставлена с документом «Исковое заявление по авиагрузовому спору» и профилем «исковое
  требование по air cargo спору»
- [ ] собран evidence bundle: claim chronology, contract, AWB/HAWB, evidence bundle, calculation, state duty
  estimate, proof of service
- [ ] проверены claim notice, limitation period, proof of delivery/service и authority signer
- [ ] оценено ограничение: нельзя формулировать исковые требования без подсудности, claim amount и
  доказательства вручения
...
Внеплановый пересмотр нужен после события: pre-filing review, limitation period или settlement window; также
...
При пересмотре Legal проверяет закрытые дела профиля «исковое требование по air cargo спору»: какие evidence
...
> Применять «Исковое заявление по авиагрузовому спору» после подтверждения владельцем процесса; спорные и нетиповые кейсы требуют ручной проверки.
