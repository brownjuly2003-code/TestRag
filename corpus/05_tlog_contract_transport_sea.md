...
title: Договор резервного фидерного плеча авиагруза
...
- Правила Гааго-Висби
keywords:
- резервное фидерное плечо авиагруза
- порт
- carrier feeder asset
- air cargo supporting document
confidentiality: internal
---

# Договор резервного фидерного плеча авиагруза

## Назначение

Шаблон резервного фидерного плеча для авиагруза; sea terms используются только если air cargo booking прямо включает pre-carriage/on-carriage и не заменяют AWB. Используется в авиагрузовой логистике ООО «Северный Контур» для проверки booking, AWB/MAWB/HAWB, terminal acceptance, screening, ULD/pallet records и акты; эскалация в юридический отдел происходит при damage/loss, offload, missed cutoff, customs/security hold, temperature excursion, terminal charges или insurance regress.

## Область применения

Логист, диспетчер, склад и авиагрузовой терминал используют документ «Договор резервного фидерного плеча авиагруза» для контроля air cargo booking, приемки на терминале, прохождения security screening, build-up, handover to carrier и recovery at destination. Для dangerous goods, lithium batteries, pharma/cold chain, perishables, oversized и valuable cargo добавляется проверка IATA DGR, SDS/shipper's declaration, температурного профиля, специальных разрешений, security status и valuable cargo instructions.

## Термины

- **Рабочий экземпляр «Договор резервного фидерного плеча авиагруза»** — версия документа с датой, владельцем процесса, статусом согласования и приложениями, по которой можно принимать внутреннее решение.
- **Основание применения «Договор резервного фидерного плеча авиагруза»** — заявка, приказ, договор, акт, обращение или иной первичный документ, без которого ассистент не должен формировать окончательный вывод.
...
| `port_loading` | Порт погрузки | `{{port_loading}}` |
| `port_discharge` | Порт выгрузки | `{{port_discharge}}` |
...
- Владелец процесса проверяет, что «Договор резервного фидерного плеча авиагруза» применяется к
  подтвержденной air cargo операции, а не к общей перевозке без booking, AWB/MAWB/HAWB и terminal record.
- Рабочий комплект: sea-air transfer, bill of lading, terminal release, customs status и AWB handover.
...
- Срок реакции: контроль выполняется до переключения sea leg на авиарейс; missed cutoff, failed screening,
...
- Основания для HOLD/STOP: коносамент подменяет AWB или не подтвержден cargo release в аэропортовый
  терминал. Неподтвержденные даты, суммы, персональные данные, пломбы, вес, temperature mode и реквизиты не
  подставляются.
- Маршрут эскалации: sea forwarder, customs broker, air terminal, carrier/GSA и legal; спорный RAG-ответ,
...
- Предметная проверка: признаки «резервное фидерное плечо авиагруза, airport terminal, AWB, booking» сверяются с исходными документами и не используются как общий ярлык.

## Air cargo профиль документа

- Для «Договор резервного фидерного плеча авиагруза» air cargo профиль строится вокруг подтвержденного
...
- Предметная опора документа: sea-air transfer, bill of lading, terminal release, customs status и AWB
  handover. Эти факты должны быть видны в TMS/WMS/terminal log, акте, фото, переписке carrier/GSA или
  связанном документе.
...
- Special cargo требует ручной проверки для dangerous goods, lithium batteries, pharma/cold chain,
  perishables, oversized и valuable cargo; HOLD наступает, если коносамент подменяет AWB или не подтвержден
  cargo release в аэропортовый терминал.
- Эскалация идет через sea forwarder, customs broker, air terminal, carrier/GSA и legal, чтобы документ не
  превращался в общий транспортный шаблон без авиационных доказательств.
## Правила ответа RAG-ассистента

- Использовать документ как источник типа «договор перевозки груза» по теме «Договор резервного фидерного плеча авиагруза» только при фактическом совпадении запроса с предметом документа.
...
- Если фактов по «Договор резервного фидерного плеча авиагруза» не хватает, вернуть уточняющие вопросы; даты, суммы, доступы и реквизиты оставлять неподтвержденными до проверки.
...
- ключевые признаки документа: резервное фидерное плечо авиагруза, airport terminal, AWB, booking.
...
| Какие факты нужны для «Договор резервного фидерного плеча авиагруза»? | Перечислить недостающие даты, документы, участников, суммы/сроки и ответственных. |
| Можно ли применять автоматически? | Только после проверки ограничений по «Договор резервного фидерного плеча авиагруза»; при риске или неполных фактах нужна ручная проверка. |
...
| Терминал / склад / наземное плечо | передает для «Договор резервного фидерного плеча авиагруза» booking, AWB, terminal records, CMR/ТТН и GPS только как first/last mile evidence |
...
- ключевые признаки (резервное фидерное плечо авиагруза, airport terminal, AWB, booking) могут быть неверно применены без документа-основания.
...
- ответ решает именно сценарий «Договор резервного фидерного плеча авиагруза» и не подменяет его общим правилом категории.
...
- ключевые признаки (резервное фидерное плечо авиагруза, airport terminal, AWB, booking) использованы только вместе с подтвержденными документами.
...
- [ ] запрос сопоставлен с документом «Договор резервного фидерного плеча авиагруза» и типом «договор перевозки груза»
...
- [ ] недостающие факты по «Договор резервного фидерного плеча авиагруза» вынесены в уточняющие вопросы
...
> Применять «Договор резервного фидерного плеча авиагруза» после подтверждения владельцем процесса; спорные и нетиповые кейсы требуют ручной проверки.
