...
title: Претензия авиаперевозчику об утрате или недостаче груза
...
# Претензия авиаперевозчику об утрате или недостаче груза

## Назначение

Претензия авиаперевозчику об утрате или недостаче груза используется для сценария: cargo manifest и фактическая
выдача расходятся по количеству мест, весу или пломбам. Это претензия контрагенту для конкретного air cargo
dispute, а не общая форма без shipment evidence.

Позиция строится на доказательствах: AWB/HAWB, cargo manifest, shortage report, warehouse receipt, release note,
seal photos, inventory reconciliation. AWB/MAWB/HAWB, airport pair, flight number, terminal/GHA records, customs
и dangerous goods учитываются только как проверяемые факты, ограничения или причины эскалации.

## Область применения

Документ применяется, когда карточка спора подтверждает профиль «утрата или недостача мест», сторону спора,
...
признания вины или долга. Для события «розыск груза, insurer notice или escalation to carrier tracing desk»
Legal согласует escalation route с operations, finance, insurer, broker или external counsel.

## Термины

- **Утрата или недостача мест** — профиль претензии или письма, который определяет предмет доказывания и
  безопасную позицию.
- **Evidence bundle** — AWB/HAWB, cargo manifest, shortage report, warehouse receipt, release note, seal photos,
  inventory reconciliation; комплект используется для chronology, liability, amount, mitigation и вручения.
- **Без признания** — ответ не подтверждает долг, вину, causation, размер ущерба, waiver of rights или отказ от
  liability cap.
- **Escalation trigger** — розыск груза, insurer notice или escalation to carrier tracing desk; событие требует
...
- Владелец спора сверяет профиль «утрата или недостача мест», карточку спора, срок ответа, способ вручения и
  evidence: AWB/HAWB, cargo manifest, shortage report, warehouse receipt, release note, seal photos, inventory
  reconciliation.
...
- Эскалация обязательна при событии: розыск груза, insurer notice или escalation to carrier tracing desk. До
...
- Сценарий: получатель выявил недостачу мест после release, а manifest и delivery order расходятся.
...
- Подтвердить источниками: AWB/MAWB/HAWB, booking, flight number, cargo manifest, акт терминала или GHA, фото повреждения или расхождения, отметки screening/handling/customs, temperature log при special cargo, invoices/rate sheet, переписка с авиаперевозчиком, GHA, экспедитором, customs broker и страховщиком. Дополнительно: shortage report, manifest extract, delivery order, warehouse receipt, trace request.
...
- Использовать документ как источник типа «претензия контрагенту» по теме «Претензия авиаперевозчику об утрате или недостаче груза» только при фактическом совпадении запроса с air cargo dispute.
...
- Основные источники: AWB/HAWB, cargo manifest, shortage report, warehouse receipt, release note, seal photos,
...
- Проверяемое ограничение: нельзя считать утрату доказанной без terminal shortage act и сверки
  offload/arrival/release.
...
| Какие факты нужны для «Претензия авиаперевозчику об утрате или недостаче груза»? | Перечислить недостающие AWB, booking, рейс, airport pair, timeline события, сумму, доказательства вручения и ответственных. |

## Ответственные роли

| Роль | Зона ответственности |
|------|----------------------|
| Руководитель юридического отдела | утверждает позицию по профилю «утрата или недостача мест», settlement authority, waiver и спорные liability caps |
| Cargo tracing owner | ведет chronology, evidence bundle, срок ответа и коммуникацию по событию: розыск груза, insurer notice или escalation to carrier tracing desk |
| Air cargo operations / GHA contact | подтверждает для «Претензия авиаперевозчику об утрате или недостаче груза» movement, acceptance/offload/release, terminal act, handling records и operational root cause |
| Finance / insurer / broker contact | сверяет по «Претензия авиаперевозчику об утрате или недостаче груза» сумму требования, reserve, оплату, customs costs, insurance notice и право регресса |

## Риски и ограничения

- Нельзя направлять документ без evidence по профилю «утрата или недостача мест»: AWB/HAWB, cargo manifest,
  shortage report, warehouse receipt, release note, seal photos, inventory reconciliation.
- Ключевое ограничение: нельзя считать утрату доказанной без terminal shortage act и сверки
  offload/arrival/release.
...
- ответ относится к профилю «утрата или недостача мест» и не подменяет его общей претензионной процедурой
- доказательства названы предметно: AWB/HAWB, cargo manifest, shortage report, warehouse receipt, release note,
  seal photos, inventory reconciliation
- отдельно указано ограничение или gap: нельзя считать утрату доказанной без terminal shortage act и сверки
  offload/arrival/release
- срок ответа, способ вручения, escalation route и safe legal position отражены явно

## Контрольный список

- [ ] карточка спора сопоставлена с документом «Претензия авиаперевозчику об утрате или недостаче груза» и
  профилем «утрата или недостача мест»
- [ ] собран evidence bundle: AWB/HAWB, cargo manifest, shortage report, warehouse receipt, release note, seal
  photos, inventory reconciliation
- [ ] проверены claim notice, limitation period, proof of delivery/service и authority signer
- [ ] оценено ограничение: нельзя считать утрату доказанной без terminal shortage act и сверки
  offload/arrival/release
...
Внеплановый пересмотр нужен после события: розыск груза, insurer notice или escalation to carrier tracing desk;
...
При пересмотре Legal проверяет закрытые дела профиля «утрата или недостача мест»: какие evidence сработали,
...
> Применять «Претензия авиаперевозчику об утрате или недостаче груза» после подтверждения владельцем процесса; спорные и нетиповые кейсы требуют ручной проверки.
