---
doc_id: legal_reply_cargo_damage
title: Ответ на претензию о повреждении авиагруза
...
# Ответ на претензию о повреждении авиагруза

## Назначение

Ответ на претензию о повреждении авиагруза используется для сценария: компания отвечает на претензию о
повреждении и запрашивает missing terminal evidence. Это ответ на претензию для конкретного air cargo dispute, а
не общую форму без shipment evidence.

Позиция строится на доказательствах: incoming claim, AWB/HAWB, damage report, photos, cargo manifest, release
note, carrier/GHA investigation, insurer notice. AWB/MAWB/HAWB, airport pair, flight number, terminal/GHA
records, customs и dangerous goods учитываются только как проверяемые факты, ограничения или причины эскалации.

## Область применения

Документ применяется, когда карточка спора подтверждает профиль «ответ на damage claim», сторону спора, сумму
...
признания вины или долга. Для события «request for missing evidence, without prejudice reply или insurer
coordination» Legal согласует escalation route с operations, finance, insurer, broker или external counsel.

## Термины

- **Ответ на damage claim** — профиль претензии или письма, который определяет предмет доказывания и безопасную
  позицию.
- **Evidence bundle** — incoming claim, AWB/HAWB, damage report, photos, cargo manifest, release note,
  carrier/GHA investigation, insurer notice; комплект используется для chronology, liability, amount, mitigation
  и вручения.
- **Без признания** — ответ не подтверждает долг, вину, causation, размер ущерба, waiver of rights или отказ от
  liability cap.
- **Escalation trigger** — request for missing evidence, without prejudice reply или insurer coordination;
...
- Владелец спора сверяет профиль «ответ на damage claim», карточку спора, срок ответа, способ вручения и
  evidence: incoming claim, AWB/HAWB, damage report, photos, cargo manifest, release note, carrier/GHA
  investigation, insurer notice.
...
- Эскалация обязательна при событии: request for missing evidence, without prejudice reply или insurer
  coordination. До решения текст не должен признавать долг, вину, causation, сумму ущерба или отказ от прав.
...
- Сценарий: заявитель требует компенсацию, но не приложил terminal damage report и фото выдачи.
...
- Подтвердить источниками: AWB/MAWB/HAWB, booking, flight number, cargo manifest, акт терминала или GHA, фото повреждения или расхождения, отметки screening/handling/customs, temperature log при special cargo, invoices/rate sheet, переписка с авиаперевозчиком, GHA, экспедитором, customs broker и страховщиком. Дополнительно: incoming claim, missing evidence request, carrier/GHA investigation, photo bundle.
...
- Использовать документ как источник типа «ответ на претензию» по теме «Ответ на претензию о повреждении авиагруза» только при фактическом совпадении запроса с air cargo dispute.
...
- Основные источники: incoming claim, AWB/HAWB, damage report, photos, cargo manifest, release note, carrier/GHA
  investigation, insurer notice.
...
- Проверяемое ограничение: нельзя признавать damage cause или amount до проверки custody timeline и liability
  cap.
...
| Какие факты нужны для «Ответ на претензию о повреждении авиагруза»? | Перечислить недостающие AWB, booking, рейс, airport pair, timeline события, сумму, доказательства вручения и ответственных. |

## Ответственные роли

| Роль | Зона ответственности |
|------|----------------------|
| Руководитель юридического отдела | утверждает позицию по профилю «ответ на damage claim», settlement authority, waiver и спорные liability caps |
| Damage reply owner | ведет chronology, evidence bundle, срок ответа и коммуникацию по событию: request for missing evidence, without prejudice reply или insurer coordination |
| Air cargo operations / GHA contact | подтверждает для «Ответ на претензию о повреждении авиагруза» movement, acceptance/offload/release, terminal act, handling records и operational root cause |
| Finance / insurer / broker contact | сверяет по «Ответ на претензию о повреждении авиагруза» сумму требования, reserve, оплату, customs costs, insurance notice и право регресса |

## Риски и ограничения

- Нельзя направлять документ без evidence по профилю «ответ на damage claim»: incoming claim, AWB/HAWB, damage
  report, photos, cargo manifest, release note, carrier/GHA investigation, insurer notice.
- Ключевое ограничение: нельзя признавать damage cause или amount до проверки custody timeline и liability cap.
...
- ответ относится к профилю «ответ на damage claim» и не подменяет его общей претензионной процедурой
- доказательства названы предметно: incoming claim, AWB/HAWB, damage report, photos, cargo manifest, release
  note, carrier/GHA investigation, insurer notice
- отдельно указано ограничение или gap: нельзя признавать damage cause или amount до проверки custody timeline и
  liability cap
- срок ответа, способ вручения, escalation route и safe legal position отражены явно

## Контрольный список

- [ ] карточка спора сопоставлена с документом «Ответ на претензию о повреждении авиагруза» и профилем «ответ на
  damage claim»
- [ ] собран evidence bundle: incoming claim, AWB/HAWB, damage report, photos, cargo manifest, release note,
  carrier/GHA investigation, insurer notice
- [ ] проверены claim notice, limitation period, proof of delivery/service и authority signer
- [ ] оценено ограничение: нельзя признавать damage cause или amount до проверки custody timeline и liability
  cap
...
Внеплановый пересмотр нужен после события: request for missing evidence, without prejudice reply или insurer
coordination; также после нового claim pattern, изменения carrier/GHA rules, customs practice, insurance
wording, limitation period или судебной практики.

При пересмотре Legal проверяет закрытые дела профиля «ответ на damage claim»: какие evidence сработали, какие
...
> Применять «Ответ на претензию о повреждении авиагруза» после подтверждения владельцем процесса; спорные и нетиповые кейсы требуют ручной проверки.
