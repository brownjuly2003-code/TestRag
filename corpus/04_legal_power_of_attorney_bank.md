...
title: Доверенность на банковские и страховые действия по air cargo claim
...
# Доверенность на банковские и страховые действия по air cargo claim

## Назначение

Доверенность на банковские и страховые действия по air cargo claim используется для сценария: представитель
получает выплаты, подписывает банковские формы или страховые документы по claim. Это доверенность для
конкретного air cargo dispute, а не общая форма без shipment evidence.

Позиция строится на доказательствах: power scope, claim file, AWB/HAWB, bank forms, insurance claim forms,
beneficiary details, authority approvals. AWB/MAWB/HAWB, airport pair, flight number, terminal/GHA records,
customs и dangerous goods учитываются только как проверяемые факты, ограничения или причины эскалации.

## Область применения

Документ применяется, когда карточка спора подтверждает профиль «банковские и страховые действия», сторону
...
признания вины или долга. Для события «insurance payout, bank guarantee call или payment receipt» Legal
согласует escalation route с operations, finance, insurer, broker или external counsel.

## Термины

- **Банковские и страховые действия** — профиль претензии или письма, который определяет предмет доказывания и
  безопасную позицию.
- **Evidence bundle** — power scope, claim file, AWB/HAWB, bank forms, insurance claim forms, beneficiary
  details, authority approvals; комплект используется для chronology, liability, amount, mitigation и вручения.
- **Без признания** — ответ не подтверждает долг, вину, causation, размер ущерба, waiver of rights или отказ от
  liability cap.
- **Escalation trigger** — insurance payout, bank guarantee call или payment receipt; событие требует решения по
...
Предмет полномочий: Доверенность на банковские и страховые действия по air cargo claim
...
- Владелец спора сверяет профиль «банковские и страховые действия», карточку спора, срок ответа, способ вручения
  и evidence: power scope, claim file, AWB/HAWB, bank forms, insurance claim forms, beneficiary details,
  authority approvals.
...
- Эскалация обязательна при событии: insurance payout, bank guarantee call или payment receipt. До решения текст
...
- Сценарий: представитель получает bank statements и подает insurance claim по damage case.
...
- Подтвердить источниками: AWB/MAWB/HAWB, booking, flight number, cargo manifest, акт терминала или GHA, фото повреждения или расхождения, отметки screening/handling/customs, temperature log при special cargo, invoices/rate sheet, переписка с авиаперевозчиком, GHA, экспедитором, customs broker и страховщиком. Дополнительно: bank statement request, insurance claim form, payment ledger, policy, subrogation draft.
...
- Использовать документ как источник типа «доверенность» по теме «Доверенность на банковские и страховые действия по air cargo claim» только при фактическом совпадении запроса с air cargo dispute.
...
- Основные источники: power scope, claim file, AWB/HAWB, bank forms, insurance claim forms, beneficiary details,
  authority approvals.
...
- Проверяемое ограничение: нельзя давать право распоряжения средствами без лимита, счета, срока и конкретного
  claim reference.
...
| Какие факты нужны для «Доверенность на банковские и страховые действия по air cargo claim»? | Перечислить недостающие AWB, booking, рейс, airport pair, timeline события, сумму, доказательства вручения и ответственных. |

## Ответственные роли

| Роль | Зона ответственности |
|------|----------------------|
| Руководитель юридического отдела | утверждает позицию по профилю «банковские и страховые действия», settlement authority, waiver и спорные liability caps |
| Treasury authorization owner | ведет chronology, evidence bundle, срок ответа и коммуникацию по событию: insurance payout, bank guarantee call или payment receipt |
| Air cargo operations / GHA contact | подтверждает для «Доверенность на банковские и страховые действия по air cargo claim» movement, acceptance/offload/release, terminal act, handling records и operational root cause |
| Finance / insurer / broker contact | сверяет по «Доверенность на банковские и страховые действия по air cargo claim» сумму требования, reserve, оплату, customs costs, insurance notice и право регресса |

## Риски и ограничения

- Нельзя направлять документ без evidence по профилю «банковские и страховые действия»: power scope, claim file,
  AWB/HAWB, bank forms, insurance claim forms, beneficiary details, authority approvals.
- Ключевое ограничение: нельзя давать право распоряжения средствами без лимита, счета, срока и конкретного claim
  reference.
...
- ответ относится к профилю «банковские и страховые действия» и не подменяет его общей претензионной процедурой
- доказательства названы предметно: power scope, claim file, AWB/HAWB, bank forms, insurance claim forms,
  beneficiary details, authority approvals
- отдельно указано ограничение или gap: нельзя давать право распоряжения средствами без лимита, счета, срока и
  конкретного claim reference
- срок ответа, способ вручения, escalation route и safe legal position отражены явно

## Контрольный список

- [ ] карточка спора сопоставлена с документом «Доверенность на банковские и страховые действия по air cargo
  claim» и профилем «банковские и страховые действия»
- [ ] собран evidence bundle: power scope, claim file, AWB/HAWB, bank forms, insurance claim forms, beneficiary
  details, authority approvals
- [ ] проверены claim notice, limitation period, proof of delivery/service и authority signer
- [ ] оценено ограничение: нельзя давать право распоряжения средствами без лимита, счета, срока и конкретного
  claim reference
...
Внеплановый пересмотр нужен после события: insurance payout, bank guarantee call или payment receipt; также
...
При пересмотре Legal проверяет закрытые дела профиля «банковские и страховые действия»: какие evidence
...
> Применять «Доверенность на банковские и страховые действия по air cargo claim» после подтверждения владельцем процесса; спорные и нетиповые кейсы требуют ручной проверки.
