...
title: Претензия экспедитору по нарушению air cargo booking или AWB
...
# Претензия экспедитору по нарушению air cargo booking или AWB

## Назначение

Претензия экспедитору по нарушению air cargo booking или AWB используется для сценария: экспедитор пропустил
booking, неверно оформил AWB/HAWB или не передал документы в терминал. Это претензия контрагенту для конкретного
air cargo dispute, а не общая форма без shipment evidence.

Позиция строится на доказательствах: expedition order, booking confirmation, AWB/HAWB draft/final,
correspondence, terminal rejection, flight status, cost calculation. AWB/MAWB/HAWB, airport pair, flight number,
terminal/GHA records, customs и dangerous goods учитываются только как проверяемые факты, ограничения или
причины эскалации.

## Область применения

Документ применяется, когда карточка спора подтверждает профиль «нарушение экспедитором booking/AWB», сторону
...
признания вины или долга. Для события «expeditor cure notice, rebooking approval или claim escalation» Legal
согласует escalation route с operations, finance, insurer, broker или external counsel.

## Термины

- **Нарушение экспедитором booking/awb** — профиль претензии или письма, который определяет предмет доказывания
  и безопасную позицию.
- **Evidence bundle** — expedition order, booking confirmation, AWB/HAWB draft/final, correspondence, terminal
  rejection, flight status, cost calculation; комплект используется для chronology, liability, amount,
  mitigation и вручения.
- **Без признания** — ответ не подтверждает долг, вину, causation, размер ущерба, waiver of rights или отказ от
  liability cap.
- **Escalation trigger** — expeditor cure notice, rebooking approval или claim escalation; событие требует
...
- Владелец спора сверяет профиль «нарушение экспедитором booking/AWB», карточку спора, срок ответа, способ
  вручения и evidence: expedition order, booking confirmation, AWB/HAWB draft/final, correspondence, terminal
  rejection, flight status, cost calculation.
...
- Эскалация обязательна при событии: expeditor cure notice, rebooking approval или claim escalation. До решения
...
- Сценарий: forwarder неверно оформил HAWB, из-за чего груз не прошел acceptance до cutoff.
...
- Подтвердить источниками: AWB/MAWB/HAWB, booking, flight number, cargo manifest, акт терминала или GHA, фото повреждения или расхождения, отметки screening/handling/customs, temperature log при special cargo, invoices/rate sheet, переписка с авиаперевозчиком, GHA, экспедитором, customs broker и страховщиком. Дополнительно: shipment instructions, HAWB drafts, booking history, terminal rejection notice, rebooking charges.
...
- Использовать документ как источник типа «претензия контрагенту» по теме «Претензия экспедитору по нарушению air cargo booking или AWB» только при фактическом совпадении запроса с air cargo dispute.
...
- Основные источники: expedition order, booking confirmation, AWB/HAWB draft/final, correspondence, terminal
  rejection, flight status, cost calculation.
...
- Проверяемое ограничение: нельзя требовать убытки без proof of instruction, cutoff timeline и causation с
  missed flight.
...
| Какие факты нужны для «Претензия экспедитору по нарушению air cargo booking или AWB»? | Перечислить недостающие AWB, booking, рейс, airport pair, timeline события, сумму, доказательства вручения и ответственных. |

## Ответственные роли

| Роль | Зона ответственности |
|------|----------------------|
| Руководитель юридического отдела | утверждает позицию по профилю «нарушение экспедитором booking/AWB», settlement authority, waiver и спорные liability caps |
| Forwarder claim owner | ведет chronology, evidence bundle, срок ответа и коммуникацию по событию: expeditor cure notice, rebooking approval или claim escalation |
| Air cargo operations / GHA contact | подтверждает для «Претензия экспедитору по нарушению air cargo booking или AWB» movement, acceptance/offload/release, terminal act, handling records и operational root cause |
| Finance / insurer / broker contact | сверяет по «Претензия экспедитору по нарушению air cargo booking или AWB» сумму требования, reserve, оплату, customs costs, insurance notice и право регресса |

## Риски и ограничения

- Нельзя направлять документ без evidence по профилю «нарушение экспедитором booking/AWB»: expedition order,
  booking confirmation, AWB/HAWB draft/final, correspondence, terminal rejection, flight status, cost
  calculation.
- Ключевое ограничение: нельзя требовать убытки без proof of instruction, cutoff timeline и causation с missed
  flight.
...
- ответ относится к профилю «нарушение экспедитором booking/AWB» и не подменяет его общей претензионной
  процедурой
- доказательства названы предметно: expedition order, booking confirmation, AWB/HAWB draft/final,
  correspondence, terminal rejection, flight status, cost calculation
- отдельно указано ограничение или gap: нельзя требовать убытки без proof of instruction, cutoff timeline и
  causation с missed flight
- срок ответа, способ вручения, escalation route и safe legal position отражены явно

## Контрольный список

- [ ] карточка спора сопоставлена с документом «Претензия экспедитору по нарушению air cargo booking или AWB» и
  профилем «нарушение экспедитором booking/AWB»
- [ ] собран evidence bundle: expedition order, booking confirmation, AWB/HAWB draft/final, correspondence,
  terminal rejection, flight status, cost calculation
- [ ] проверены claim notice, limitation period, proof of delivery/service и authority signer
- [ ] оценено ограничение: нельзя требовать убытки без proof of instruction, cutoff timeline и causation с
  missed flight
...
Внеплановый пересмотр нужен после события: expeditor cure notice, rebooking approval или claim escalation; также
...
При пересмотре Legal проверяет закрытые дела профиля «нарушение экспедитором booking/AWB»: какие evidence
...
> Применять «Претензия экспедитору по нарушению air cargo booking или AWB» после подтверждения владельцем процесса; спорные и нетиповые кейсы требуют ручной проверки.
